...
hero:
  ...
  tagline: Create interactive viewers for large bioimaging data
  actions:
    - theme: brand
      text: Get Started
...
features:
  ...
  - title: Composable architecture
    details: Mix and match cameras, controls, layers, and data sources to build exactly the viewer your data needs.
---
