...
features:
  ...
  - title: Chunk streaming
    ...
    details: Chunks are streamed based on what the camera needs at the current zoom and nothing more. Preconfigured policies allow for smooth temporal playback.
