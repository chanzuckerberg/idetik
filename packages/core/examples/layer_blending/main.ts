...
blendSelect?.addEventListener("change", (e) => {
    overlayLayer.setBlendingMode((e.target as HTMLSelectElement).value as BlendingMode);
});
...
const opacitySlider = document.querySelector<HTMLInputElement>("#opacitySlider");
