...
This reference is not a tutorial. It does not explain workflows or provide step-by-step examples. For that, start with the [User Guide](/guide/getting-started). Use the reference when you need exact information: types, functions, parameters, and guarantees.
