import { FrameUniforms } from "./shared/frame_uniforms";
import { LayerUniforms } from "./shared/layer_uniforms";

export const ImageScalarUnsigned = /* wgsl */ `
  struct Varyings {
