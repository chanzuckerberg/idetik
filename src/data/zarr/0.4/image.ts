...
export type Image = {
   ...
   */
  multiscales: Array<
    any[] | boolean | number | number | null | MultiscaleObject | string
  >;
  omero?: Omero;
  [property: string]: any;
};

export type MultiscaleObject = {
  version: any;
  metadata: any;
  type: any;
  name: any;
...
const typeMap: any = {
    ...
    [
      {
        json: "multiscales",
        js: "multiscales",
        typ: a(u(a("any"), true, 3.14, 0, null, r("MultiscaleObject"), "")),
      },
      { json: "omero", js: "omero", typ: u(undefined, r("Omero")) },
    ],
    "any"
  ),
  MultiscaleObject: o(
  ...
  Omero: o([{ json: "channels", js: "channels", typ: a(r("Channel")) }], "any"),
  Channel: o(
    [
