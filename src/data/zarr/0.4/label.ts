// To parse this data:
//
//   import { Convert, Label } from "./file";
//
...
export class Convert {
  public static toLabel(json: string): Label {
    return cast(JSON.parse(json), r("Label"));
  }

  public static labelToJson(value: Label): string {
    return JSON.stringify(uncast(value, r("Label")), null, 2);
  }
}
...
const typeMap: any = {
  ...
  Color: o(
    [
      { json: "label-value", js: "label-value", typ: 3.14 },
      { json: "rgba", js: "rgba", typ: u(undefined, a(0)) },
    ],
    "any"
  ),
  Property: o([{ json: "label-value", js: "label-value", typ: 0 }], "any"),
  Source: o([{ json: "image", js: "image", typ: u(undefined, "") }], "any"),
  Version: ["0.4"],
};
